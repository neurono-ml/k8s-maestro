...
impl<'a> super::SecurityClient for crate::client::MaestroClient {
    fn client(&self) -> &crate::client::MaestroClient {
        self
    }

    /// Returns network policy builder for creating network policies.
    fn network_policy(&self) -> crate::security_client::NetworkPolicyBuilder {
        crate::security_client::NetworkPolicyBuilder::new(self.client().namespace())
    }

    /// Returns resource quota builder for creating resource quotas.
    fn resource_quota(&self) -> crate::security_client::ResourceQuotaBuilder {
        crate::security_client::ResourceQuotaBuilder::new(self.client().namespace())
    }

    /// Returns security context builder for creating pod/container security contexts.
    fn security_context(&self) -> crate::security_client::PodSecurityContextBuilder {
        crate::security_client::PodSecurityContextBuilder::new(self.client().namespace())
    }

    /// Returns security context config builder for creating security configurations.
    fn security_context_config(&self) -> crate::security_client::SecurityContextConfig {
        crate::security_client::SecurityContextConfig::new()
    }

    /// Returns service account builder for creating service accounts.
    fn service_account(&self) -> crate::security_client::ServiceAccountBuilder {
        crate::security_client::ServiceAccountBuilder::new(self.client().namespace())
    }

    /// Returns role builder for creating roles.
    fn role(&self) -> crate::security_client::RoleBuilder {
        crate::security_client::RoleBuilder::new(self.client().namespace())
    }

    /// Returns cluster role builder for creating cluster roles.
    fn cluster_role(&self) -> crate::security_client::ClusterRoleBuilder {
        crate::security_client::ClusterRoleBuilder::new()
    }

    /// Returns role binding builder for creating role bindings.
    fn role_binding(&self) -> crate::security_client::RoleBindingBuilder {
        crate::security_client::RoleBindingBuilder::new(self.client().namespace())
    }

    /// Returns cluster role binding builder for creating cluster role bindings.
    fn cluster_role_binding(&self) -> crate::security_client::ClusterRoleBindingBuilder {
        crate::security_client::ClusterRoleBindingBuilder::new()
    }

    /// Returns policy rule builder for creating RBAC policy rules.
    fn rbac_policy_rule(&self) -> crate::security_client::RbacPolicyRule {
        crate::security_client::RbacPolicyRule::new()
    }

    /// Returns limit range builder for creating limit ranges.
    fn limit_range(&self) -> crate::security_client::LimitRangeBuilder {
        crate::security_client::LimitRangeBuilder::new(self.client().namespace())
    }

    /// Lists all workflows in the client's namespace.
    ///
    /// # Returns
    ///
    /// Returns a vector of workflows.
    pub fn list_workflows(&self) -> Result<Vec<CreatedWorkflow>> {
        if self.dry_run {
            log::info!(
                "DRY RUN: Would list workflows in namespace '{}'",
                self.namespace
            );
            return Ok(Vec::new());
        }

        log::info!("Listing workflows in namespace '{}'", self.namespace);
